...
export default function Footer() {
  ...
  return (
    <footer className="relative border-t border-white/[0.06] bg-background py-12 px-6">
      <div className="container-max">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-4">
            ...
            <span className="text-text-subtle text-sm hidden sm:block">
          ...
          <nav className="flex flex-wrap items-center gap-6 justify-center">
            {FOOTER_LINKS.map((link) => (
              <button
                ...
                className="text-text-muted hover:text-white transition-colors duration-200 text-sm"
              >
                {link.label}
              </button>
            ))}
          ...
          <div className="flex items-center gap-3">
            {[
              ...
              <motion.a
                ...
                whileTap={{ scale: 0.95 }}
                className="p-2 rounded-lg text-text-muted hover:text-white hover:bg-white/[0.06] transition-all duration-200"
              >
                {social.icon}
              </motion.a>
            ))}
